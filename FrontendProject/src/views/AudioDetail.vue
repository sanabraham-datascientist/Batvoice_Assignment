<template>
  ...
  <div class="container mx-auto">
    <div class="flex flex-col">
      <div
        class="relative flex flex-col items-center mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3"
      >
